...
namespace Teresa
{
    public static class Wait
    {
        ...
        /// <summary>
        /// This method execute any commands wrapped as a ByIndex periodically until it is timeout.
        ...
        {
            if (timeoutMills < 0)
                throw new InvalidEnumArgumentException("The timeout in milliseconds cannot be a negative value.");
