...
namespace TeresaUnitTesting.WaitUntilTests
{
    class Test
    {
        ...
        static void Main()
        {
            ...
            startTick = Environment.TickCount;
            Assert.Catch<TimeoutException>(()=>Wait.Until(predicate2, 5000))
            ;
            ...
            number = 1;
            startTick = Environment.TickCount;
            Assert.Catch<TimeoutException>(()=>GenericWait<int>.Until(getNumber, i => i < 0));
